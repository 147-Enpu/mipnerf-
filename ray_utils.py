...
def sample_along_rays(origins, directions, radii, num_samples, near, far, randomized, lindisp, ray_shape):
    ...
    # print("far:", far.shape)
    # t_vals: torch.Size([65])
    # num_samples: 64
    # near: torch.Size([1024])
    # far: torch.Size([1024])
    ...
    # print("ray_shape:",ray_shape)
    # t_vals: torch.Size([1024, 65])
    # origins: torch.Size([1024, 3])
    # directions: torch.Size([1024, 3])
    # radii: torch.Size([1024, 1, 1])
    # ray_shape: cone
...
def volumetric_rendering(rgb, density, t_vals, dirs, white_bkgd):
    ...
    return comp_rgb, distance, acc, weights, alpha, bg_lambda
